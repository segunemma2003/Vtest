<template>
    <div>
        <div class="form-group">
            ...
            <input type="email" v-model="user.name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        ...
        <div class="form-group">
            ...
            <input type="password" v-model="user.c_password" class="form-control" id="exampleInputPassword1">
        </div>
